...
const Home = () => {
    return (
        // The main container padding is removed for full-width content on mobile
        <div className="bg-bg-light-gray">
            
            {/* Hero Section */}
            <div className="p-4 sm:p-[20px] bg-white rounded-none sm:rounded-3xl"> 
                <section 
                    className="relative h-[600px] sm:h-[725px] bg-cover bg-center rounded-none sm:rounded-3xl overflow-hidden" 
                    style={{ 
